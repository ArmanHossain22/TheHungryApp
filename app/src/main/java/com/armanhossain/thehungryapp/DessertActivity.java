...
public class DessertActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<Dish> desertDishAdapter = new ArrayAdapter<Dish>(this, android.R.layout.simple_list_item_1, desertDishArray);

        dessertsListView.setAdapter(desertDishAdapter);
    }
}